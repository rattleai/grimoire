...
- `references/api-reference.md` — full 472-operation table with method, path, summary, parameters, request body fields, response codes, and schema names. **Read this** when you need to compose any specific call.
